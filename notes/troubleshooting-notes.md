...
Where telemetry was incomplete, the investigation recorded the limitation rather than filling the missing fields with assumptions.

The working rule was:

```text
Observed artifact ≠ confirmed behavior
